...
namespace Doozy.Editor.UI.Animation
{
    public class BaseAnimationDrawer : BaseDrawer
    {
        ...
        {
            if ((Doozy.Engine.UI.Animation.EaseType) Properties.Get(PropertyName.EaseType, property).enumValueIndex == Doozy.Engine.UI.Animation.EaseType.Ease)
                Elements.DrawLine(drawRect,
        ...
        protected void DrawLineEaseTypeEaseAnimationCurveRotateMode(Rect drawRect, SerializedProperty property)
        {
            ...
            if ((Doozy.Engine.UI.Animation.EaseType) easeType.enumValueIndex == Doozy.Engine.UI.Animation.EaseType.Ease)
                Elements.DrawLine(drawRect,
